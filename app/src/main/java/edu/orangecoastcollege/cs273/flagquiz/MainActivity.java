...
public class MainActivity extends AppCompatActivity {
    ...
    public void resetQuiz() {
        ...
        while (mQuizCountriesList.size() < FLAGS_IN_QUIZ)
        {
            ...
            //Determine whether to add the random county
    ...
    public void makeGuess(View v) {
        ...
        if (guess.equals(mCorrectCountry.getName()))
        {
            ...
            {
                // Wait two seconds, then load the next flag
    ...
    @Override
    // Responds to the user clicking the gear icon
    ...
    /**
     * Updates the number of choices visible to the user, disables and makes invisible any excess choices.
     */
    private void updateChoices() {
        // Enable/Show all the linear layouts < mChoices / 2
        // Disable/Hide all the others
        // Let's loop through all the linear layout
    ...
    /**
     * Updates the list of countries used for the current quiz to use only countries in the selected region.
     */
